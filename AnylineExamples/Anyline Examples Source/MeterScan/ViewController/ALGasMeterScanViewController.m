...
NSString * const kMeterScanLicenseKey = kDemoAppLicenseKey;
...
@interface ALGasMeterScanViewController ()<AnylineEnergyModuleDelegate, AnylineNativeBarcodeDelegate>
...
- (void)viewDidLoad {
    ...
    self.controllerType = ALScanHistoryGasMeter;
