...
@interface ALAutoAnalogDigitalMeterScanViewController ()<AnylineEnergyModuleDelegate, AnylineNativeBarcodeDelegate>
...
- (void)viewDidLoad {
    ...
    self.title = @"Analog/Digital Meter"; //Analog Meter
