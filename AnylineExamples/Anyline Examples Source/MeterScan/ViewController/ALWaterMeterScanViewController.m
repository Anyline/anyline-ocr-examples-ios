...
NSString * const kWaterMeterScanLicenseKey = kDemoAppLicenseKey;
...
@interface ALWaterMeterScanViewController ()<AnylineEnergyModuleDelegate, AnylineNativeBarcodeDelegate>
...
- (void)viewDidLoad {
    ...
    self.controllerType = ALScanHistoryWaterMeter;
