...
- (void)viewDidLoad {
    ...
    self.title = @"Serial Number"; //Analog Meter
    ...
    self.anylineEnergyView.serialNumberCharWhitelist = @"ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789";
    self.anylineEnergyView.serialNumberValidationRegex = @"[A-Z0-9]{4,}";
