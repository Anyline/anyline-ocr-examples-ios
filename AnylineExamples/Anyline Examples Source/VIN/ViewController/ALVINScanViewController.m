...
NSString * const kVINLicenseKey = @"";
...
- (void)viewDidLoad {
    ...
    config.charHeight = ALRangeMake(20, 80);
    config.tesseractLanguages = @[@"eng_no_dict", @"deu"];
    config.charWhiteList = @"1234567890ABCDEFGHJKLMNPRSTUVWXYZ";
    config.minConfidence = 75;
    config.scanMode = ALLine;
    config.validationRegex = @"^([A-HJ-NP-Z0-9]{9})([A-HJ-NPR-TV-Z,0-9])([A-HJ-NP-Z0-9])(\\d{6})$";
    ...
    NSString *confPath = [[NSBundle mainBundle] pathForResource:@"VIN_config" ofType:@"json"];
...
//    [overlay setText:[self formattedVINText:result.text]];
...
- (NSString *)formattedVINText:(NSString*)originalString {
