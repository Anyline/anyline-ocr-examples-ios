...
NSString * const kBarcodePDF417_configJSONFilename = @"barcode_pdf417_in_id";
...
- (void)viewDidLoad {
    ...
    self.scanViewPlugin = [[ALScanViewPlugin alloc] initWithJSONDictionary:configJSONDictionary error:nil];
