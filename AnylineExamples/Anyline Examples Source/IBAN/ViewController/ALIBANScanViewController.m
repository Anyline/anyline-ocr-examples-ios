...
@interface ALIBANScanViewController ()<ALOCRScanPluginDelegate, ALInfoDelegate>
...
-(void)viewDidAppear:(BOOL)animated {
    ...
    [self updateWarningPosition:
     self.ibanScanViewPlugin.cutoutRect.origin.y +
     self.ibanScanViewPlugin.cutoutRect.size.height +
     self.ibanScanViewPlugin.frame.origin.y +
     120];
}
...
- (void)startAnyline {
    NSError *error;
    BOOL success = [self.ibanScanViewPlugin startAndReturnError:&error];
    if( !success ) {
